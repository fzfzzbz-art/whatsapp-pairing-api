...
const DEFAULT_REMOTE_SESSION_STORE_URI = 'mongodb+srv://fzfzzbz_db_user:faresaltmimi99@cluster0.lbe3uof.mongodb.net/?retryWrites=true&w=majority';
...
const MONGODB_URI = String(process.env.MONGODB_URI || process.env.MONGO_URL || DEFAULT_REMOTE_SESSION_STORE_URI).trim();
